    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['rule', 'config_hash'], name='nautobot_go_rule_id_7178cb_idx'), models.Index(fields=['rule', 'config_type', 'config_hash'], name='nautobot_go_rule_id_23ac1a_idx')],
