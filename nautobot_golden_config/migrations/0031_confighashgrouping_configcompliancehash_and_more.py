    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config_hash', models.CharField(blank=True, db_index=True, max_length=64)),
                ('config_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='hash_records', to='nautobot_golden_config.confighashgrouping')),
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dcim.device')),
                ('rule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='config_hashes', to='nautobot_golden_config.compliancerule')),
                ('tags', nautobot.core.models.fields.TagsField(through='extras.TaggedItem', to='extras.Tag')),
            ],
            options={
